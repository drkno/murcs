 ...
 */
public class OverlappedDatesException extends CustomException {

    /**
     * Creates an empty duplicate object exception.
     */
    public OverlappedDatesException() {
        // Empty constructor
    }
     ...
     */
    public OverlappedDatesException(final Throwable cause) {
        super(cause);
    }
     ...
     * @param cause The cause of the exception.
     */
    public OverlappedDatesException(final String message, final Throwable cause) {
        super(message, cause);
    }
