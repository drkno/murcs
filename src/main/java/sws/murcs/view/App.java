...
public class App extends Application {
    ...
    public final void start(final Stage primaryStage) throws Exception {
        ...
        scene.getStylesheets()
                .add(getClass()
                .getResource("/sws/murcs/styles/materialDesign/materialDesignButtonRound.css")
                .toExternalForm());
        scene.getStylesheets()
                .add(getClass()
                .getResource("/sws/murcs/styles/materialDesign/materialDesignButtonRoundDelete.css")
                .toExternalForm());
        scene.getStylesheets()
