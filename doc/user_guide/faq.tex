...
Yes. The current bugs that we know of include: \newline \begin{itemize}
  ...
  \item The user is not alerted when removing a team member with a assigned role (PO or SM) from a team.
  \item (Minor or unnoticeable) When generating information the releases have odd names, also generated objects like people may end up being assigned to multiple teams which they shouldn't be able to do.
\end{itemize}
}

\faqentry{Have you ever really had any questions?}{No. But we are assuming these questions will we asked frequently, if you do actually have any questions please ask them so we can flesh out this FAQ section.}
