...
Yes. The current bugs that we know of include: \newline \begin{itemize}
  \item In extreme cases when the application is populated with a lot of data which is being manipulated, the application can use more memory than is desired and potentually hang. This issue is set to be minised in the next release
